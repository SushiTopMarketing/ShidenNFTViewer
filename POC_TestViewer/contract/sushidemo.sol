...
contract sushidemo is  ERC721URIStorage , ERC721Enumerable {

    address public owner;

    uint256 public nftid = 1;

    string currentURI = "https://arweave.net/mpZ2NuzXdzyDTofaTPRqDYpSfQp5p4xI2pU6npc0eOw";
    ...
    constructor() ERC721("sushidemo" , "DEMO" ) {
        owner = _msgSender();
    } 
